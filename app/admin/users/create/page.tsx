    ...
    return (
        <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 font-sans relative">
            <SimpleModal
                ...
                title={t('admin.addUser.title') || 'Error'}
            ...
            <div className="w-full max-w-sm flex flex-col items-center mb-8">
                <h1 className="text-xl font-extrabold text-gray-900 tracking-tight mb-8">
                    {t('admin.addUser.title') || 'Add User'}
                </h1>
            </div>
                ...
                <form action={handleFormSubmit} className="space-y-5">
                    ...
                    <div className="space-y-1">
                        ...
                        <select
                            ...
                            defaultValue={state?.inputs?.role || "USER"}
                        >
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="flex items-center gap-4">
                            {previewUrl && (
                                <img src={previewUrl} alt="Preview" className="w-16 h-16 rounded-full object-cover border border-gray-200" />
                            )}
                    ...
                    {/* Confirm Password */}
                    <div className="space-y-1">
                        <SimpleLabel htmlFor="confirmPassword">{t('register.confirmPassword')}</SimpleLabel>
                        <div className="relative">
                            <Input
                                id="confirmPassword"
...
function RegisterButton() {
    ...
    return (
        <Button className="w-full font-bold text-base shadow-lg shadow-blue-500/30" aria-disabled={pending}>
            {pending ? '...' : (t('admin.addUser.submit') || 'Create User')}
        </Button>
    );
}
